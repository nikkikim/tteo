...
if(/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)){
    ...
    document.writeln("<style>body{margin:0;}</style><div style='width:100%;height:100%;background-color:black;'><img style='width:30%;position:absolute;top:50%;left:50%;transform:translate(-50%, -50%);' src='color2.jpeg'></div>");
    // window.stop();
}
